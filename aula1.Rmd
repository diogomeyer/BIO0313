...
(c) Explore o efeito de alterar a intensidade de seleção natural. Numa escala evolutiva, qual a sua impressão sobre a velocidade com que a seleção natural pode fixar uma mutação vantajosa?
...
(a) Examine a probabilidade de fixação para o cenário neutro e o com seleçõa. Essa diferença faz sentido para você? Como a probabilidade de fixação no caso de seleção constrasta com o que vimos no modelo determinístico (em que não há deriva)?

(b) Dobre a vantagem associada à mutação, levando o valor para s=0,02, e calcule a nova probabilidade de fixação. O aumento da intensidade de seleção afetou a probabilidade de fixação?

(c) Repita agora os dois itens acima (probabilidade de fixação para uma mutação neutra, uma com s=0,01, e uma com s=0,02), para uma população muito pequena, com N=5. O que mudou, em relação ao cenário de N=1000?
...
[Deixar claro que N=50 indivíduos implica em N=100 na linguate do programa e 1/2N é 0,01 na frequencia inicial]
